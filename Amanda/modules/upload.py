...
from Amanda import telethn as bot
from Amanda.modules.urluploader import download_file
from Amanda.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @TheAmandabot",
            )
        except Exception as e:
            traceback.print_exc()
