...
# from Amanda.modules.sql import warns_sql as warnssql
import Amanda.modules.sql.blacklist_sql as blacklistsql

# from Amanda.modules.sql import cust_filters_sql as filtersql
# import Amanda.modules.sql.welcome_sql as welcsql
import Amanda.modules.sql.locks_sql as locksql
import Amanda.modules.sql.notes_sql as sql

# from Amanda.modules.rules import get_rules
import Amanda.modules.sql.rules_sql as rulessql
from Amanda import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
from Amanda.__main__ import DATA_IMPORT
from Amanda.modules.connection import connected
...
from Amanda.modules.sql import disable_sql as disabledsql
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @trtechguide"
            )
